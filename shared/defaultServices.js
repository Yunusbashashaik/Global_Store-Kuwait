...
export const DEFAULT_SERVICES = [
  {
    ...
    imageUrl: "/service-images/netflix-prime-combo.jpg",
  },
  {
    id: "prime-video-shared",
    icon: "🎬",
    accent: "#00a8e1",
    typeEn: "Shared Account",
    typeAr: "حساب مشترك",
    ...
    prices: { month: 1, year: 8 },
    imageUrl: "/service-images/prime-video-shared.jpg",
  },
  {
    id: "prime-video-private",
    icon: "🎬",
    accent: "#00a8e1",
    typeEn: "Private Screen",
    typeAr: "شاشة خاصة",
    ...
    imageUrl: "/service-images/prime-video-private.jpg",
  },
  {
    id: "prime-video-full",
    icon: "🎬",
    ...
    imageUrl: "/service-images/prime-video-full.jpg",
  },
  {
    ...
    imageUrl: "/service-images/netflix-full-account.jpg",
  },
  {
    id: "netflix-private-screen",
    icon: "🎬",
    accent: "#e50914",
    typeEn: "Private Screen",
    typeAr: "شاشة خاصة",
    ...
    imageUrl: "/service-images/netflix-private-screen.jpg",
  },
  {
    id: "apple-music-premium-shared",
    icon: "🎵",
    accent: "#fc3c44",
    typeEn: "Shared Account",
    typeAr: "حساب مشترك",
    ...
    imageUrl: "/service-images/apple-music-premium-shared.jpg",
  },
  {
    id: "mubi-premium-shared",
    icon: "🎬",
    accent: "#000000",
    typeEn: "Shared Account",
    typeAr: "حساب مشترك",
    ...
    prices: { month: 0, year: 0 },
    imageUrl: "/service-images/mubi-premium-shared.jpg",
  },
  {
    id: "osn-plus-premium-shared",
    icon: "🎬",
    accent: "#6d28d9",
    typeEn: "Shared Account",
    typeAr: "حساب مشترك",
    ...
    prices: { month: 0, year: 0 },
    imageUrl: "/service-images/osn-plus-premium-shared.jpg",
  },
  {
    id: "crunchyroll-premium-shared",
    icon: "🍥",
    accent: "#f47521",
    typeEn: "Shared Account",
    typeAr: "حساب مشترك",
    ...
    prices: { month: 1, year: 8 },
    imageUrl: "/service-images/crunchyroll-premium-shared.jpg",
  },
  {
    ...
    prices: { month: 1, year: 8 },
    imageUrl: "/service-images/grammarly-premium.jpg",
  },
  {
    ...
    prices: { month: 1, year: 8 },
    imageUrl: "/service-images/youtube-premium-personal.jpg",
  },
  {
    ...
    imageUrl: "/service-images/chatgpt-plus-shared.jpg",
  },
  {
    id: "grok-ai-premium",
    icon: "🤖",
    ...
    prices: { month: 1, year: 8 },
    imageUrl: "/service-images/grok-ai-premium.jpg",
  },
  {
    id: "gemini-ai-18-months",
    icon: "🤖",
    accent: "#4285f4",
    typeEn: "One Device",
    typeAr: "جهاز واحد",
    ...
    prices: { month: 1, year: 8 },
    imageUrl: "/service-images/gemini-ai-18-months.jpg",
  },
  {
    id: "canva-pro-available",
    icon: "🎨",
    accent: "#00c4cc",
    typeEn: "One Device",
    typeAr: "جهاز واحد",
    ...
    prices: { month: 1, year: 8 },
    imageUrl: "/service-images/canva-pro-available.jpg",
  },
  {
    ...
    prices: { month: 0, year: 0 },
    imageUrl: "/service-images/disney-plus-premium.jpg",
  },
  {
    id: "zee5-premium",
    icon: "📺",
    ...
    prices: { month: 0, year: 0 },
    imageUrl: "/service-images/zee5-premium.jpg",
  },
  {
    id: "hulu-premium",
    icon: "📺",
    ...
    prices: { month: 0, year: 0 },
    imageUrl: "/service-images/hulu-premium.jpg",
  },
  {
    id: "ullu-premium",
    icon: "📺",
    ...
    prices: { month: 0, year: 0 },
    imageUrl: "/service-images/ullu-premium.jpg",
  },
  {
    id: "spotify-premium",
    icon: "🎵",
    ...
    prices: { month: 1, year: 8 },
    imageUrl: "/service-images/spotify-premium.jpg",
  },
  {
    id: "nordvpn-available",
    icon: "🛡️",
    accent: "#4687ff",
    typeEn: "VPN",
    typeAr: "VPN",
    ...
    prices: { month: 1, year: 8 },
    imageUrl: "/service-images/nordvpn-available.jpg",
  },
  {
    id: "capcut-pro-available",
    icon: "🎞️",
    accent: "#00f2ea",
    typeEn: "Pro Access",
    typeAr: "وصول Pro",
    ...
    imageUrl: "/service-images/capcut-pro-available.jpg",
  },
  {
    id: "peacock-premium",
    icon: "🦚",
    ...
    prices: { month: 0, year: 0 },
    imageUrl: "/service-images/peacock-premium.jpg",
  },
  {
    id: "sony-liv-premium",
    icon: "📺",
    ...
    prices: { month: 0, year: 0 },
    imageUrl: "/service-images/sony-liv-premium.jpg",
  },
  {
    id: "starzplay-available",
    icon: "🎬",
    accent: "#0399fa",
    typeEn: "Premium",
    typeAr: "بريميوم",
    ...
    prices: { month: 0, year: 0 },
    imageUrl: "/service-images/starzplay-available.jpg",
  },
  {
    id: "surfshark-vpn-available",
    icon: "🦈",
    accent: "#1e5eff",
    typeEn: "VPN",
    typeAr: "VPN",
    ...
    prices: { month: 1, year: 8 },
    imageUrl: "/service-images/surfshark-vpn-available.jpg",
  },
  {
    ...
    prices: { month: 1.5, year: 10 },
    imageUrl: "/service-images/expressvpn-premium.jpg",
  },
  {
    id: "proton-vpn-premium",
    icon: "🔒",
    accent: "#6d4aff",
    typeEn: "One Device",
    typeAr: "جهاز واحد",
    ...
    prices: { month: 1, year: 8 },
    imageUrl: "/service-images/proton-vpn-premium.jpg",
  },
  {
    id: "apple-tv-plus-available",
    icon: "🍎",
    accent: "#a2aaad",
    typeEn: "Premium",
    typeAr: "بريميوم",
    ...
    prices: { month: 1, year: 8 },
    imageUrl: "/service-images/apple-tv-plus-available.jpg",
  },
  {
    id: "hbo-max-available",
    icon: "🎬",
    accent: "#b535f6",
    typeEn: "Premium",
    typeAr: "بريميوم",
    ...
    prices: { month: 1, year: 8 },
    imageUrl: "/service-images/hbo-max-available.jpg",
  },
  {
    id: "paramount-plus-available",
    icon: "🌟",
    accent: "#0064ff",
    typeEn: "Premium",
    typeAr: "بريميوم",
    ...
    prices: { month: 0, year: 0 },
    imageUrl: "/service-images/paramount-plus-available.jpg",
  },
  {
    id: "shahid-vip-available",
    icon: "🌟",
    accent: "#00d4aa",
    typeEn: "VIP",
    typeAr: "VIP",
    ...
    prices: { month: 0, year: 0 },
    imageUrl: "/service-images/shahid-vip-available.jpg",
  },
  {
    id: "genspark-ai",
    icon: "✨",
    ...
    imageUrl: "/service-images/genspark-ai.jpg",
  },
  {
    id: "claude-ai",
    icon: "🤖",
    ...
    imageUrl: "/service-images/claude-ai.jpg",
  },
  {
    id: "magic-light-ai",
    icon: "✨",
    ...
    prices: { month: 8, year: 90 },
    imageUrl: "/service-images/magic-light-ai.jpg",
  },
  {
    id: "chaupal-available",
    icon: "🎬",
    accent: "#f59e0b",
    typeEn: "Premium",
    typeAr: "بريميوم",
    ...
    prices: { month: 1, year: 8 },
    imageUrl: "/service-images/chaupal-available.jpg",
  },
  {
    id: "tod-subscription",
    icon: "⚽",
    ...
    prices: { month: 0, year: 0 },
    imageUrl: "/service-images/tod-subscription.jpg",
  },
  {
    ...
    prices: { month: 1, year: 8 },
    imageUrl: "/service-images/iptv-subscription.jpg",
  },
  {
    id: "tiktok-usa-accounts",
    icon: "🔥",
    accent: "#fe2c55",
    typeEn: "USA Account",
    typeAr: "حساب أمريكي",
    ...
    prices: { month: 1, year: 8 },
    imageUrl: "/service-images/tiktok-usa-accounts.jpg",
  },
  {
    id: "esim-travel-plans",
    icon: "📶",
    accent: "#2563eb",
    typeEn: "Travel eSIM",
    typeAr: "شريحة سفر",
    ...
    prices: { month: 1, year: 8 },
    imageUrl: "/service-images/esim-travel-plans.jpg",
  },
  {
    id: "whatsapp-number",
    icon: "📱",
    accent: "#25d366",
    typeEn: "WhatsApp Number",
    typeAr: "رقم واتساب",
    ...
    prices: { month: 1, year: 8 },
    imageUrl: "/service-images/whatsapp-number.jpg",
  }
];
