export const COPY = {
  en: {
    ...
    catalogEmpty: "No subscriptions yet. Add services in Admin to show them here.",
    month: "1 Month",
    year: "1 Year",
    ...
    adminExportCatalog: "Download catalog backup",
    adminImportCatalog: "Restore catalog backup",
    adminCatalogExported: "Catalog backup downloaded.",
    adminCatalogImported: "Catalog restored from backup.",
  ...
  ar: {
    ...
    catalogEmpty: "لا توجد اشتراكات بعد. تُضاف الخدمات في ملف الكتالوج بالمشروع وتظهر بعد النشر.",
    month: "شهر واحد",
    year: "سنة واحدة",
    ...
    adminExportCatalog: "تنزيل نسخة الكتالوج",
    adminImportCatalog: "استعادة نسخة الكتالوج",
    adminCatalogExported: "تم تنزيل نسخة الكتالوج.",
    adminCatalogImported: "تمت استعادة الكتالوج من النسخة الاحتياطية.",
